...
{
    const float totalDensity = 0.0215;
    ...
    vec3 uvw = pos * NOISE_SCALE * 0.0001;
    uvw.x +=  1.13 * 0.1 * (frameTimeCounter * 0.006) * WIND_SPEED;
    uvw.z += 0.7 * 0.1 * (frameTimeCounter * 0.006) * WIND_SPEED;
    float baseDensity = 0.0033;
