...
const vec3 skylightColor = vec3(0.5647, 0.651, 0.9961);
const vec3 sunlightColor= vec3(0.8706, 0.7725, 0.4471) * 1.34;
const vec3 morningSunlightColor = vec3(1.0, 0.5098, 0.2078);
