...
void main(){
	...
	float handedness=clamp(at_tangent.w*inf,-1.,1.);// -1.0 when at_tangent.w is negative, and 1.0 when it's positive
	...
	feetPlayerPos=(gbufferModelViewInverse*vec4(viewPos,1.)).xyz;
