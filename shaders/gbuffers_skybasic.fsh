...
const vec3 dayHorCol=vec3(0.5843, 0.7294, 0.8745);
...
const vec3 dawnGrndCol=vec3(0.1882, 0.4, 0.549);
...
void main() {
  ...
  float interpFactor = (t - keyFrames[i]) / max(1e-6, keyFrames[i + 1] - keyFrames[i]);
